...
<template>
  <PageHeader
    title="如故题库"
    subtitle="纯前端刷题站，数据留在本机。可导入题库、收藏笔记，并一键部署到 GitHub Pages。"
  >
    <div class="hero">
      <div class="hero__panel">
        <p class="hero__eyebrow">专业 · 本地 · GitHub Pages</p>
        ...
        <div class="hero__actions">
          ...
          <RouterLink class="btn btn--ghost" to="/guide">使用手册</RouterLink>
        </div>
      </div>
      <ul class="hero__list">
        <li>仓库 <code>banks/</code> 构建收录 + 浏览器导入 / AI 辅助</li>
        <li>题库标签（如学年）· 搜索 / 练习 / 考试按题库与标签筛选（默认或运算）</li>
